...
api_fingerprint = "<API_KEY_FINGERPRINT"
# api_private_key      = <<EOT
...
api_private_key_path = "<YOUR_PRIVATE_KEY_PATH>"
...
compartment_id = "<COMPARTMENT_TO_USE_AS_ROOT>"
label_prefix   = "dev"
...
# bastion host
# BASTION IMAGE IS NOT COMPATIBLE WITH ARM64 - WONT CREATE
create_bastion_host = false
bastion_access      = ["anywhere"]
bastion_image_id    = "ocid1.image.oc1.ap-singapore-1.aaaaaaaayadqhujvohknwo2uz4rmr3ejdha4ufmgrbdhmgrfrhr7r3qpstyq"
...
# operator host
# OPERATOR IMAGE IS NOT COMPATIBLE WITH ARM64 - WONT CREATE
...
cluster_name                 = "oke"
# NEEDED TO INSTALL CALICO WITH CALICO-OVER-FLANNEL MODE
cni_type                     = "flannel"
...
node_pools = {
  # Basic node pool
  # OKE PROVIDES 4 CPUs AND 24 GBs MONTHLY FOR FREE
  np1 = {
   shape            = "VM.Standard.A1.Flex",
   ocpus            = 2,
   memory           = 12,
...
calico_mode              = "vxlan"
calico_mtu               = 8950     # automatic if 0
